...
_default = {
    ...
    "cache_max_age": defaults.SECONDS_IN_DAY,
    "cache_min_size": consts.SIZE_KB * 4,
    "fs_cache_filename": defaults.CACHE_FILENAME,
    "fs_cache_dir": defaults.CACHE_DIR,
    "fs_cache_dir_level": defaults.CACHE_DIR_LEVEL,
    "fs_cache_segment_size": defaults.CACHE_SEGMENT_SIZE,
    "fs_cache_file_ext": "",
    "logger": None,
    "lmdb_map_size": consts.SIZE_MB * 4,
    "lmdb_filename": defaults.CACHE_FILENAME,
